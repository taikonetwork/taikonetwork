...
class Group(models.SalesforceModel):
    ...
    founding_date = models.DateField(db_column='Founding_Date__c',
    ...
    non_us_country = models.CharField(
        db_column='Non_US_Country__c', max_length=1300,
        verbose_name='Non-US Country', sf_read_only=models.READ_ONLY, blank=True)
...
class Member(models.SalesforceModel):
    ...
    email_readonly = models.EmailField(
    ...
    is_deleted = models.BooleanField(
        db_column='IsDeleted', verbose_name='Deleted', sf_read_only=models.READ_ONLY)
...
class GroupAlt(django.db.models.Model):
